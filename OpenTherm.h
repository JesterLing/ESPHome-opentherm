...
public:
	...
	void begin(std::function<void()> handleInterruptCallback);
	void begin(std::function<void()> handleInterruptCallback, std::function<void(uint32_t, OpenThermResponseStatus)> processResponseCallback);
	bool isReady();
...
private:
	...
	std::function<void(uint32_t, OpenThermResponseStatus)> processResponseCallback;
	std::function<void()> handleInterruptCallback;
