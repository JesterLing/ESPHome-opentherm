...
void OpenTherm::begin(std::function<void()> handleInterruptCallback, std::function<void(uint32_t, OpenThermResponseStatus)> processResponseCallback)
{
	pinMode(inPin, INPUT);
...
void OpenTherm::begin(std::function<void()> handleInterruptCallback)
{
